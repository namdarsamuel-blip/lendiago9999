  ...
  <div class="container mx-auto px-4 md:px-6">
    ...
    <div class="max-w-3xl mb-14 md:mb-20 reveal">
      ...
      <p class="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl">
        Seven funding products covering working capital, equipment, real estate, and credit. Apply once, and we match you to the option that actually fits.
      </p>
    </div>
...
<section class="py-16 md:py-20">
  ...
  window.LendiagoRenderFAQ = function(){
    ...
    const faqs = [
      ['What types of business funding does Lendiago offer?','We offer seven tailored products: Business Term Loans, Merchant Cash Advances, Business Lines of Credit, Credit Stacking, SBA Loans, Real Estate Loans, and Personal Term Loans.'],
