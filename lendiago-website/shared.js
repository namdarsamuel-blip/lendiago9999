...
<style id="lendiago-mobile-overrides">
  ...
  @media (max-width: 1023px) {
    ...
    section { padding-top: clamp(2.5rem, 8vw, 3.5rem) !important; padding-bottom: clamp(2.5rem, 8vw, 3.5rem) !important; }
    /* Hero gets a little more breathing room */
    main > section:first-of-type { padding-top: 2rem !important; padding-bottom: 3rem !important; }

    /* Headline rhythm */
    h1 { font-size: clamp(2rem, 8.5vw, 2.75rem) !important; line-height: 1.08 !important; letter-spacing: -0.02em !important; }
    h2 { font-size: clamp(1.625rem, 6vw, 2rem) !important; line-height: 1.12 !important; letter-spacing: -0.015em !important; }
    h3 { font-size: clamp(1.125rem, 4.5vw, 1.375rem) !important; line-height: 1.2 !important; }

    /* Body copy: tighter, more readable */
    main p { font-size: 0.9375rem; line-height: 1.6; }
    main .text-xl, main .text-2xl { font-size: 1.0625rem !important; line-height: 1.55 !important; }
  ...
  /* unused legacy block */
  .x-removed-section {
    /* Center most asymmetric grids on phones so things sit balanced */
    main [class*="md:col-span-7"][class*="reveal-l"],
    main [class*="md:col-span-7"][class*="reveal-r"],
    main [class*="md:col-span-5"][class*="reveal-l"],
    main [class*="md:col-span-5"][class*="reveal-r"],
    main [class*="md:col-span-4"][class*="reveal-l"],
    main [class*="md:col-span-4"][class*="reveal-r"],
    main [class*="lg:col-span-7"][class*="reveal-l"],
    main [class*="lg:col-span-7"][class*="reveal-r"],
    main [class*="lg:col-span-5"][class*="reveal-l"],
    main [class*="lg:col-span-5"][class*="reveal-r"] {
      max-width: 100% !important;
    }
    /* Headlines/lead paragraphs centered on phones for editorial pages */
    main h1, main h2 { letter-spacing: -0.015em; }
    /* Eyebrow + accent rule: stays left-aligned (consistent) */
    /* Hero asymmetric splits become single column on phones */
    main .grid.md\\:grid-cols-2 > * + *,
    main .grid.md\\:grid-cols-12 > * + * { margin-top: 0; }
    ...
    /* Section heading -> body gap tightening */
    h2 + p, h2 + div { margin-top: 0.75rem; }

    /* Buttons: minimum 48px hit target */
    a.inline-flex, button, .btn { min-height: 48px; }
    a.inline-flex[class*="px-"], button[class*="px-"] { padding-top: 0.875rem; padding-bottom: 0.875rem; }

    /* Cards: subtle shadow + cleaner edges */
    .shadow-premium { box-shadow: 0 4px 16px -8px rgba(0,0,0,0.08), 0 2px 4px -2px rgba(0,0,0,0.05); }

    /* Tables / spec grids: stack cleanly */
    .grid.md\\:grid-cols-3 > div { padding-left: 0 !important; }
    /* Hairline dividers between columns on desktop -> top borders on mobile */
    .md\\:border-l { border-left: 0 !important; }
    .md\\:pl-10, .md\\:pl-16 { padding-left: 0 !important; }
    main .grid > div + div[class*="border-l"] { border-top: 1px solid hsl(var(--border)); padding-top: 1.5rem; margin-top: 0.5rem; }
    ...
    /* CENTER editorial content on mobile — headlines, copy, eyebrows */
    main section h1, main section h2, main section h3, main section h4 { text-align: center; }
    ...
    /* Hero CTAs and primary action rows — center */
    main .flex.flex-col.sm\\:flex-row { justify-content: center; align-items: center; }
    main .flex.items-baseline { justify-content: center; }
    /* Lists keep left-aligned content but containers center */
    main ul, main ol, main details { text-align: left; }
    main dl { text-align: left; }
    /* Card content stays naturally aligned (left) — only override at the section level */
    main [class*="border"] p, main [class*="card"] p, main details p { text-align: left; }
    main [class*="border"] h3, main [class*="card"] h3, main details h3 { text-align: left; }
    main .grid h3, main .grid h4 { text-align: left; }
    main .grid p { text-align: left; }
    main .grid .flex.items-center.gap-4 { justify-content: flex-start; }
    /* But the "eyebrow > headline > paragraph" lede block always centers */
    main section > .container > .reveal > .flex.items-center.gap-4,
    main section > .container > div > .reveal > .flex.items-center.gap-4 { justify-content: center; }
  }
