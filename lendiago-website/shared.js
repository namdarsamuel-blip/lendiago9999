...
<style id="lendiago-mobile-overrides">
  ...
  .x-removed-section {
    ...
    main .grid .flex.items-center.gap-4 { justify-content: center; }
    /* Center any icon/image inside a grid item */
    main .grid > * > svg:first-child,
    main .grid > * > .inline-flex,
    main .grid > * > .flex:first-child { margin-left: auto; margin-right: auto; }
    /* Numbered eyebrow rows (e.g. "01 / Benefit" with hairline) — center */
