...
<style id="lendiago-mobile-overrides">
  ...
  .x-removed-section {
    ...
    /* Hero illustration on home: smaller on phones, doesn't dominate the screen */
    ...
    /* Forms and explicit lists keep left alignment (natural for input) */
    ...
    /* Bordered/card containers keep left alignment (cards look weird centered) */
    main [class*="bg-white"][class*="border"] p,
    main [class*="bg-white"][class*="border"] h3,
    main [class*="bg-white"][class*="border"] h4,
    main [class*="bg-white"][class*="rounded"] p,
    main [class*="bg-white"][class*="rounded"] h3,
    main [class*="bg-white"][class*="rounded"] h4 { text-align: left; }
    main [class*="bg-white"][class*="border"] .flex.items-center.gap-4,
    main [class*="bg-white"][class*="rounded"] .flex.items-center.gap-4 { justify-content: flex-start; }
