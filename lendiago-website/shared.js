...
<style id="lendiago-mobile-overrides">
  ...
  @media (max-width: 1023px) {
    ...
    body { -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: 100%; touch-action: manipulation; }
    ...
    .carousel-item { width: 78vw !important; max-width: 320px; }
  ...
  .x-removed-section {
    ...
    /* Carousels - ensure they don't overflow */
    .carousel-viewport { overflow: hidden; }
    .carousel-track { gap: 0.75rem !important; }
    .carousel-item { width: 78vw !important; max-width: 320px; }
  }
