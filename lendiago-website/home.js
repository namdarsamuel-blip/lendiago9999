...
(function(){
  ...
  function setupCarousel(trackId){
    ...
    function dragMove(x, y, preventDefault){
    ...
    track.addEventListener('touchmove', (e)=>{ const t=e.touches[0]; dragMove(t.clientX, t.clientY, ()=>e.preventDefault()); }, { passive: false });
